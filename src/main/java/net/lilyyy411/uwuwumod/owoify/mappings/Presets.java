...
import net.lilyyy411.uwuwumod.owoify.mappings.owo.*;
import net.lilyyy411.uwuwumod.owoify.mappings.uvu.*;
import net.lilyyy411.uwuwumod.owoify.mappings.uwu.*;
import net.lilyyy411.uwuwumod.owoify.mappings.word.*;
...
public class Presets {
    ...
    public static List<Mapping> UWU_MAPPINGS = Arrays.asList(
            new BracketsToStarTrails(),
            new SpecificPunctuationToKaomoji(),
            new ThatToDat(), new ThToF(),
